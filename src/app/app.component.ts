...
@Component({
  ...
  template: `
    ...
    <div class="flex flex-col">
        <section class="px-4 md:px-6 lg:px-8">
            <div class="mx-auto max-w-4xl">
                ...
                <div class="mt-8 rounded-lg bg-white border border-gray-300 border-solid">
                    ...
                    <div class="p-4">
                        <div class="rounded-md bg-gray-100 p-4 font-mono text-sm text-gray-900 ">
                            npm run dev:css
                        </div>
                    </div>
                    <div class="px-4">Start Angular after UnoCSS has generated the <span class="font-mono">uno.css</span> file.</div>
                    <div class="p-4">
                        <div class="rounded-md bg-gray-100 p-4 font-mono text-sm text-gray-900 ">
                            npm run start
                        </div>
        ...
        <section class="px-4 md:px-6 lg:px-8">
            <div class="mx-auto max-w-4xl"><h1 class="text-3xl font-bold tracking-tight md:text-4xl">
                Presets
            </h1>
                <p class="mt-2 text-lg text-gray-500">
                ...
                <div class="mt-8 rounded-lg bg-white border border-gray-300 border-solid">
                    <div class="p-4 pb-0"><span class="font-mono">presetUno()</span> provides a common superset of: Tailwind CSS, WindiCSS, Bootstrap,
                        Tachyons,
                        etc.
                    </div>
                    <div class="p-4 pb-0">
